...
"""
	...
	Version: 1.1 (2022-07-06) modified for Python 3.7.9
...
class RemoteTypograf:
	...
	def processText(self, text):
		...
		remoteTypograf.settimeout(10)			# before
		remoteTypograf.connect((host, 80))
		# remoteTypograf.sendall(SOAPRequest.encode('utf-8')) before
		remoteTypograf.sendall(bytes(SOAPRequest, encoding = 'UTF-8'))
		...
		typografResponse = typografResponse.decode() # before
